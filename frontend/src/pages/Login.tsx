...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    // In production, use the actual Google Sign-In button
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="text-sm text-center text-gray-600">
            ...
            <p className="mt-2">1. Create Google OAuth credentials</p>
            <p>2. Set CLIENT_ID and CLIENT_SECRET in .env</p>
            <p>3. Add redirect URI: http://localhost:5173/auth/callback</p>
          </div>
        </div>
      </div>
    </div>
